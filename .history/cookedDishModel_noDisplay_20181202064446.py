...
Tensorflow-gpu using Keras and lauch in a Jupyter ipython notebook.

I use an Anaconda python3.5 environment.
...
for i in range(0, count):
    ...
    if predictions[i, 0] >= 0.5:
        print('I am {:.2%} sure this is a Mokka'.format(
            predictions[i][0]))
    else:
        print('Is not the One '.format(
            1-predictions[i][0]))
